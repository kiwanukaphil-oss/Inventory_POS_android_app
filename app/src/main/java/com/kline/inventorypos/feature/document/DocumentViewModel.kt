...
data class DocumentUiState(val documents: List<BusinessDocument> = emptyList(), val detail: BusinessDocument? = null, val type: String? = null, val status: String? = null, val query: String = "", val canCreate: Boolean = false, val canEdit: Boolean = false, val canVoid: Boolean = false, val canSend: Boolean = false, val loading: Boolean = false, val working: Boolean = false, val uncertain: Boolean = false, val error: String? = null, val message: String? = null)
